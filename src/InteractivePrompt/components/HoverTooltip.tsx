...
import { getNodeTypeFromClassName, BlockManager } from 'sendbix-base';
import { createPortal } from 'react-dom';
import { getEditorRoot, useEditorContext, useFocusIdx, useHoverIdx, useLazyState } from 'sendbix-builder';
...
export function HoverTooltip() {
  ...
  return (
    <>
      {createPortal(
        <div
          id='sendbix-addons-InteractivePrompt-HoverTooltip'
          style={{
            position: 'absolute',
            height: '100%',
            width: '100%',

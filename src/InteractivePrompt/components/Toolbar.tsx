...
import { BasicType, getParentIdx, getSiblingIdx } from 'sendbix-base';
import { useBlock, useFocusIdx, useEditorProps, isTextBlock } from 'sendbix-builder';
...
export function Toolbar() {
  ...
  return (
    <>
      <div
        id='sendbix-addons-InteractivePrompt-Toolbar'
        style={{
          height: 0,

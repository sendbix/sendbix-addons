...
import { BasicType } from 'sendbix-base';
import { createPortal } from 'react-dom';
import { IconFont, useBlock, useFocusIdx, BlockAvatarWrapper, useFocusBlockLayout } from 'sendbix-builder';
...
export function FocusTooltip() {
  ...
  return (
    <>
      {createPortal(
        <div
          id='sendbix-addons-InteractivePrompt-FocusTooltip'
          style={{
            position: 'absolute',
            width: '100%',
            height: '100%',
